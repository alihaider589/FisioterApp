...
export default class mioAccount extends Component {
    ...
    render() {
        return (
            <Container style={styles.container}>
                <View style={{ paddingHorizontal: 20, width: '100%', alignItems: 'center', justifyContent: "center" }}>
                    <ReactNative.Text style={{ fontSize: 15, marginTop: 15, fontFamily: 'Bold', color: "rgb(0, 160, 153)" }}>
                        IL MIO ACCOUNT
    </ReactNative.Text>
                </View>
                ...
                <View style={{ width: "100%", justifyContent: 'center', alignItems: "center", flexDirection: "row" }}>
                    <View style={{ width: '70%', alignSelf: "flex-start" }}>
                        ...
                        <Thumbnail large style={{ marginTop: 10, alignSelf: 'flex-end' }}
                    ...
                    <View style={{ width: '50%', alignSelf: "flex-end", }}>
                        ...
                        <TouchableOpacity >
                            ...
                            <MaterialCommunityIcons name="pencil-circle" size={30} color="rgb(0, 160, 153)" style={{ margin: 20 }} />
                        </TouchableOpacity>
                    </View>

                    {/* <View style={{backgroundColor:'yellow',justifyContent:"center",alignItems:'center',width:'50%',}}>
{/* </View> */}
                </View>
                ...
                <View style={{ width: '100%', paddingHorizontal: 25, flexDirection: "row", marginTop: 20 }}>
                    <View style={{ width: '35%', alignItems: 'center' }}>
                        <ReactNative.Text style={{ fontFamily: 'Medium', fontSize: 15, color: "rgb(148, 148, 148)" }}>
                            ID Coupon:
</ReactNative.Text>
                    ...
                    <View style={{ width: '35%', alignItems: 'center', justifyContent: "center" }}>
                        <MaterialCommunityIcons name="circle" size={30} color="rgb(0, 160, 153)" />
                    </View>
                </View>
                <View
                    style={{
