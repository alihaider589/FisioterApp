...
import ReactNative, { ScrollView, Text, View, StyleSheet, Image, TextInput, StatusBar } from 'react-native'
    ...
    render() {
        return (
            <Container style={styles.container}>
                <View style={{ marginTop: StatusBar.currentHeight, width: "100%", alignItems: 'center' }}>
                    <Image source={require('../../shared/images/fiosterApp.png')} style={{ height: 50, width: 150 }} />
                </View>
                <ScrollView style={{ width: "100%" }} >
                    <View style={{ width: '100%', paddingHorizontal: 30 }}>
                        <ReactNative.Text style={{ fontFamily: "Bold", fontSize: 20, color: 'white', marginTop: 10 }}>
                            REGISTRAZIONE  1/4
    </ReactNative.Text>
                   ...
                   <View style={{flexDirection:"row",width:'30%'}}>
                    ...
                    <Thumbnail small style={{ marginTop: '3%' }}
                        source={{ uri: 'data:image/jpeg;base64,' }} />
                            <MaterialCommunityIcons name="pencil-circle" size={20} color="white" style={{alignSelf:'flex-end',margin:5}}/>

                        </View>
                        <View style={{width:'70%',justifyContent:'flex-end',paddingHorizontal:30}}>
<ReactNative.Text style={{fontFamily:'Bold',fontSize:15,color:'white'}}>
    Fisioterapista
</ReactNative.Text>
                        </View>
                    </View>
